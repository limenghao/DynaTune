...
class RPCRunner(Runner):
    ...
    max_converge_coef: float/None, optional
        ...
        The value should be in [0,1], a suggested value is 0.1.
    """
    ...
    try:
        ...
        if max_converge_coef:
            ...
            while cur_number < number*repeat:
                ...
                # We need at least two iterations of mini-batch execution to be able to count the coefficient of variation.
